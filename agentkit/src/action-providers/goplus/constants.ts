...
export const ERROR_MESSAGES = {
  INVALID_ADDRESS: "Invalid Solana address format. Please provide a valid base58 encoded address (32-44 characters).",
  TOKEN_NOT_FOUND: "Token not found or analysis unavailable. The token may be very new or not indexed yet.",
  ...
  WRONG_ACTION_FOR_TOKEN: "This address appears to be a token. Use 'get_solana_token_security' for token analysis.",
  WRONG_ACTION_FOR_WALLET: "This address appears to be a wallet. Use 'analyze_wallet_security' for wallet analysis.",
