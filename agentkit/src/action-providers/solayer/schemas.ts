...
/**
 * Action schemas for the solayer action provider.
 *
 * This file contains the Zod schemas that define the shape and validation
 * rules for action parameters in the solayer action provider.
 */
 ...
 */
export const SolayerExampleActionSchema = z.object({
  /**
